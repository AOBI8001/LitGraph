...
assert.match(RESEARCH_SYSTEM_PROMPT, /Cite factual claims/);
...
const bounded=JSON.parse(researchMessages([{id:'1',title:'Used'},{id:'2',title:'Unused',abstract:'UNRELATED OLD TEXT',summary:'UNRELATED SUMMARY'}],[],'Q',{evidence:[{id:'E1',documentId:'1',text:'Source',contentHash:'privatehash',startOffset:0} ]})[1].content);
assert.equal(bounded.documents.length,1);
