...
5. Model-planned requests retain development-selected top-k=20 and 28,000/42,000-character quick/expert budgets. Local-fast conceptual requests use up to 6 chunks/8,000 characters for one paper, or 10 chunks/12,000 characters for multiple papers. Retain complete chunks and balanced coverage for explicitly named comparisons. A short answer is not an exhaustive literature review.
