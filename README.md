...
**1.2.6 · Windows 10 / 11 x64 · MIT 开源**
...
最新实际重测见 [1.2.6 质量与耗时报告](docs/RAG_BENCHMARK_1.2.6.md)：固定回归集参考证据召回 97.75%、严格答案准确率 100%、后端完整回答中位数 20.60 秒。该结果不是所有语料/模型的准确率保证，报告保留测试范围和人工复核限制。
